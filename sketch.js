...
fundo = loadImage("images/background.png"); // carregar a imagem do fundo (a imagem do fundo está na pasta images)
...
function setup(){
  ...
  corda = new Rope(5,{x:250,y:50});// tamanho da corda

  fruta = Bodies.circle(250,100,20); // tamanho da fruta
  ...
  cueio = createSprite(350,600,10,10); //comando pra aonde o cueio vai ficar
  ...
  balao.position(80,250); // posicao do balao
...
function draw(){
  ...
  rect(chao.position.x,chao.position.y,500,20); // <-tamanho do chão, (esta num ofrmato de retangulo)
